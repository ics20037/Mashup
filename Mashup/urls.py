...
urlpatterns = [
    ...
    path('post/<int:pk>/comment/<int:pk2>/update/', mashup_views.CommentUpdateView.as_view(), name='comment-update'),
    path('post/<int:pk>/comment/<int:pk2>/delete/', mashup_views.CommentDeleteView.as_view(), name='comment-delete'),
